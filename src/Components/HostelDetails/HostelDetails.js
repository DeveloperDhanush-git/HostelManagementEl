...
const HostelDetails = () => {
  ...
  return (
    <div className="bg-white min-h-screen rounded-lg  flex flex-col font-[Montserrat]">
      <div className="bg-white rounded-lg shadow-md overflow-hidden relative">

        {/* Back Button (No Navigation) */}
        <div
        className="absolute top-10 ml-6 left-4 z-10 cursor-pointer"
        onClick={() => navigate("MyComponentPage")} // Change route as needed
      >
