...
import RectangleMeter from "./DynamicComponents/RectangleMeter";
import UpdatesCard from "./DynamicComponents/UpdatesCard";
import SquareCard from "./DynamicComponents/SquareCard";
import Button from "./DynamicComponents/Button";
import MonthDropdown from "./DynamicComponents/MonthDropdown";
import BedsComponent from "./DynamicComponents/BedsComponent";
import FilterModal from "./../Components/DynamicComponents/FilterModal";
        ...
        <div className=" bg-white min-h-screen rounded-lg  flex flex-col">
                ...
                <div className="ml-6">
                    <div className="w-full bg-white rounded-lg shadow-md border-2 border-[#69205D] p-4">
                        <div className="flex flex-col md:flex-row items-center gap-4">
                            ...
                            <div className="bg-[#F7F7F7] px-7 py-3 rounded-md text-xl text-gray-600 w-190 mt-1">
                                <p>
                                    {(() => {
            ...
            <div className="p-4">
                <Button
                    button="View Details"
                    defaultColor="#69205D"
                    route="/hostel-details" // ✅ Pass the correct route
                />
