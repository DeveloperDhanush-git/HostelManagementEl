  ...
  return (
    <div className="  bg-white min-h-screen rounded-lg  flex flex-col">
      ...
      <div className="mt-4 w-full flex-grow space-y-6">
        ...
        <div className="bg-gray-200 p-2 rounded-md ml-6">Who can stay</div>
        <div className="space-y-6 mt-2 ml-6">
        ...
        <div className="bg-gray-200 p-2 mt-4 rounded-md ml-6">Best Suited for</div>
        <div className="space-y-6 mt-2 ml-6">
