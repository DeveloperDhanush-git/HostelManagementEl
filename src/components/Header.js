    ...
    <>
      ...
      <div className="flex items-center space-x-2 py-4">
        ...
        <div className="flex-grow bg-[#69205D] text-white p-4 flex justify-between items-center rounded-lg h-20">
          {/* Title */}
          <span className="text-[17px] sm:text-2xl font-semibold">{title}</span>
          ...
          <div className="flex items-center space-x-3">
            ...
            {/* Filter Icon - Navigates to FilterPage */}
            {(icons || []).includes("sliders") && (
              <button onClick={() => navigate("/filter")} className="bg-transparent text-white p-2 rounded-lg cursor-pointer">
